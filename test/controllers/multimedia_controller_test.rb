...
class MultimediaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create multimedium" do
    assert_difference('Multimedium.count') do
      post multimedia_url, params: { multimedium: { exhibit_id: @multimedium.exhibit_id, type: @multimedium.type } }
    end
  ...
  test "should update multimedium" do
    patch multimedium_url(@multimedium), params: { multimedium: { exhibit_id: @multimedium.exhibit_id, type: @multimedium.type } }
