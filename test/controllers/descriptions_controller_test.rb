...
class DescriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create description" do
    assert_difference('Description.count') do
      post descriptions_url, params: { description: { exhibit_id: @description.exhibit_id, text: @description.text } }
    end
  ...
  test "should update description" do
    patch description_url(@description), params: { description: { exhibit_id: @description.exhibit_id, text: @description.text } }
